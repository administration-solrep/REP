...
var styleDelete = styleDelete || 'font-weight: normal; color: #ffffff; background-color: #990033;';
var styleInsert = styleInsert || 'font-weight: normal; color: #ffffff; background-color: #009933;';
...
function comparerAction(version1, version2) {
	var result = '';
	result = result + StringDiff2(version1, version2);

	var comparaisonElement1 = document
			.getElementById('visualiserComparaisonVersion1');
	comparaisonElement1.innerHTML = '<span>' + result + '</span>';

	var result2 = '';
	result2 = result2 + StringDiff1(version1, version2);

	var comparaisonElement2 = document
			.getElementById('visualiserComparaisonVersion2');
	comparaisonElement2.innerHTML = '<span>' + result2 + '</span>';
}
