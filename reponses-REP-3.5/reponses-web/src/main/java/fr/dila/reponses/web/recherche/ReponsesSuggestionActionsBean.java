...
/**
 * Suggestion actions helpers, repris de Nuxeo entièrement pour ne pas impacter d'autre code.
 *
 * @author jgomez
 * @author Anahide Tchertchian
 * @since 5.2M4
 */
@Name("reponsesSuggestionActions")
@Scope(EVENT)
public class ReponsesSuggestionActionsBean implements Serializable {
    ...
    public void addSingleBoundSelection(ActionEvent event) {
        ...
        if (hiddenSelector != null && output != null) {
            ...
            hiddenSelector.setValue(selectedValue);
    ...
    public void addSingleSelection(ActionEvent event) {
        ...
        if (selector != null && hiddenSelector != null && output != null) {
            ...
            hiddenSelector.setValue(selection);
