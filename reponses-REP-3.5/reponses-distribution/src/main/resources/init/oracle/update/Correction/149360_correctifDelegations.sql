-- Ce script permet de corriger les utilisateurs présentant des problèmes pour gérer leur délégations
-- Il est à lancer après le script verificationDelegations 
