-- Ce script permet de corriger les utilisateurs présentant des problèmes pour visualiser leurs favoris
-- Il est à lancer après le script verificationFavoris 
