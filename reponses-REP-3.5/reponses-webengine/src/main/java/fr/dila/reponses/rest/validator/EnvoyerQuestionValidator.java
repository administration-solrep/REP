...
public class EnvoyerQuestionValidator {
    ...
    private static final String ERROR_INDEXATION_MULTIPLE_DATA_TYPE_MSG = "Présence simultanée des deux types AN/SENAT d'indexation de données non autorisée.";
    ...
    private static final String ERROR_INDEXATION_SENAT_TOO_MUCH_RENVOI_MSG = "SENAT : Le nombre de renvoi excède la limite de " + 
        INDEXATION_SENAT_NB_MAX_RENVOI + ". ";
    ...
    private static boolean isMinistereDepotValid(Ministre ministreDepot){
        return ministreDepot != null &&
            ministreDepot.getIntituleMinistere() != null &&
            ministreDepot.getTitreJo() != null;
    }
