...
public class QueryHelper {
	 ...
	 */
	public static void appendListParams(StringBuilder query, List<? extends Object> params, String schema, String property, boolean beforeAnd, boolean quoted) {
	 ...
	 * @param quoted : If true, elements are with quotes (ex: 'element')
	 */
	public static void appendParam(StringBuilder query, Object param, String schema, String property, boolean beforeAnd, boolean quoted) {
		if (param != null) {
			if (beforeAnd) {
				query.append(" AND ");
			}
			query.append(schema).append(":").append(property).append(" = ");
			appendParam(query, param, quoted);			
		}
	}
