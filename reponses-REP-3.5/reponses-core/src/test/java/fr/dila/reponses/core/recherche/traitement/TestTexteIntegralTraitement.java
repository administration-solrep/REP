...
public class TestTexteIntegralTraitement extends TestCase {
  ...
  public void testIndexHelperSenatTitre(){
      ...
      assertEquals("q.ecm:fulltext_senatTitre = \"${l''oiural} ${''est} ${-un} ${pet-ieo#,}\"",index.getFullText("l'oiural 'est -un pet-ieo#,"));
  }
  ...
  public void testIndexHelperMotsVide(){
      ReponsesFulltextIndexEnum index = ReponsesFulltextIndexEnum.SENAT_TITRE;
      index.activateUFNXQL();
      assertEquals("q.ecm:fulltext_senatTitre = \"${Une} ${voiture} ${175} ${000} ${euros}\"",index.getFullText("Une voiture à 175 000 euros"));
  }
  
  public void testIndexHelperMotsVide_2(){
      ReponsesFulltextIndexEnum index = ReponsesFulltextIndexEnum.SENAT_TITRE;
      index.activateUFNXQL();
      assertEquals("q.ecm:fulltext_senatTitre = \"${Une} ${croissance} ${15.5%}\"",index.getFullText("Une croissance à 15.5%"));
  }
