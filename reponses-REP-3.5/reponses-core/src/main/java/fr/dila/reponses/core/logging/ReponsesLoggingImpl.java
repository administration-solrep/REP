...
public class ReponsesLoggingImpl extends STDomainObjectImpl implements ReponsesLogging {
	...
	public Calendar getStartDate() {
		return PropertyUtil.getCalendarProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_START_DATE);
	}

	@Override
	public void setStartDate(Calendar startDate) {
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_START_DATE, startDate);
	}
	...
	public void setEndDate(Calendar endDate) {
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_END_DATE, endDate);
	}

	@Override
	public Long getPrevisionalCount() {
		return PropertyUtil.getLongProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
	...
	public void setPrevisionalCount(Long previsionalCount) {
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_PREVISIONNAL_COUNT, previsionalCount);
	}

	@Override
	public List<String> getReponsesLoggingLines() {
		return PropertyUtil.getStringListProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
	...
	public void setReponsesLoggingLines(List<String> reponsesLoggingLines) {
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_LINES, reponsesLoggingLines);
	}

	@Override
	public String getMessage() {
		return PropertyUtil.getStringProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
	...
	public void setMessage(String message) {
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_MESSAGE, message);
	}

	@Override
	public ReponsesLoggingStatusEnum getStatus() {
		return ReponsesLoggingStatusEnum.findById(PropertyUtil.getStringProperty(document,
				ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA, ReponsesLoggingConstant.REPONSES_LOGGING_STATUS));
	}
	...
	public void setStatus(ReponsesLoggingStatusEnum status) {
		...
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_STATUS, statusStr);
	}
	...
	public void setEndCount(Long endCount) {
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_END_COUNT, endCount);
	}
	...
	public void setClosePrevisionalCount(Long previsionalCount) {
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_CLOSE_PREVISIONNAL_COUNT, previsionalCount);
	}
	...
	public void setCloseEndCount(Long closeEndCount) {
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_CLOSE_END_COUNT, closeEndCount);
	}

	@Override
	public List<ComplexeType> getTimbres() {
		return getComplexeTypeProperty(ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_TIMBRE);
	}

	@Override
	public void setTimbres(List<ComplexeType> timbres) {
		PropertyUtil.setListSerializableProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_TIMBRE, timbres);
	}
	...
	public Map<String, String> geTimbresAsMap() {
		...
		for (ComplexeType complexeType : list) {
			map.put((String) complexeType.getSerializableMap().get(CURRENT_MIN), (String) complexeType
					.getSerializableMap().get(NEXT_MIN));
		}
		return map;
	}
	...
	protected List<ComplexeType> getComplexeTypeProperty(String schema, String value) {
		try {
			List<ComplexeType> complexeTypeList = new ArrayList<ComplexeType>();
	...
	public void setCurrentGouvernement(String currentGouvernement) {
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_CURRENT_GOUVERNEMENT, currentGouvernement);
	}
	...
	public void setNextGouvernement(String nextGouvernement) {
		PropertyUtil.setProperty(document, ReponsesLoggingConstant.REPONSES_LOGGING_SHEMA,
				ReponsesLoggingConstant.REPONSES_LOGGING_NEXT_GOUVERNEMENT, nextGouvernement);
	}
