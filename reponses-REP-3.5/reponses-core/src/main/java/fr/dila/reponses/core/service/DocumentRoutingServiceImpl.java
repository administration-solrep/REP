 ...
 * @author jtremeaux
 */
public class DocumentRoutingServiceImpl extends fr.dila.ss.core.service.DocumentRoutingServiceImpl implements DocumentRoutingService {
    ...
    @Override
    public DocumentModel getCurrentEtape(final CoreSession session, final DossierLink dossierLink) throws ClientException {
        if (dossierLink == null) {
        	return null;
        } else {
