...
public class SuggestionUtils {
	...
	private static List<IndexationItem> addVocPrefixToResults(List<String> vocs, ReponsesVocabularyService vocService,
			List<String> results) {
		List<IndexationItem> items = new ArrayList<IndexationItem>();
