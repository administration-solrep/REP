...
public class StatistiqueGroupe implements Serializable {
    ...
    public StatistiqueGroupe(long id, String ministere, String origine, String edition, String groupe, int ordreProtocolaire, boolean actif, int nbQuestion) {
        this.id = id;
    ...
    public String toString() {
        return "StatistiqueGroupe [id=" + id + ", ministere=" + ministere + ", edition=" + edition + ", groupe=" + groupe + ", ordreProtocolaire=" + ordreProtocolaire + ", actif=" + actif + ", nbQuestion=" + nbQuestion + "]";
    }
}
