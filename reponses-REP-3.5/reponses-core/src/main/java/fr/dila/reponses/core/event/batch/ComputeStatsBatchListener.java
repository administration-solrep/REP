 ...
 * @author bgd
 */
public class ComputeStatsBatchListener extends AbstractBatchEventListener {
    ...
    protected void processEvent(final CoreSession session, final Event event) throws ClientException {
        ...
        try {
        	STServiceLocator.getSuiviBatchService().createBatchResultFor(batchLoggerModel, "Génération des statistiques de la page d'accueil", endTime-startTime);
        } catch (Exception e) {
