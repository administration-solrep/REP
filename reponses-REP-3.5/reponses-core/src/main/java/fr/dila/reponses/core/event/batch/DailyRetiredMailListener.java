 ...
 * 
 */
public class DailyRetiredMailListener extends AbstractBatchEventListener {
    /**
    ...
    protected void processEvent(final CoreSession session, final Event event) throws ClientException {
        ...
        try {
        	suiviBatchService.createBatchResultFor(batchLoggerModel, "Batch d'envoi des mails journaliers de notification des retraits", endTime-startTime);
        } catch (Exception e) {
