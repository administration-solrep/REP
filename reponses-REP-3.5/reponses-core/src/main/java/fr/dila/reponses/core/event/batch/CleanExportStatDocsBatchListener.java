...
public class CleanExportStatDocsBatchListener extends AbstractBatchEventListener {
    ...
    protected void processEvent(CoreSession session, Event event) throws ClientException {
        ...
        try {
            suiviBatchService.createBatchResultFor(batchLoggerModel, "Suppression des exports statistiques existants depuis 24h", nbSuppression, endTime-startTime);
        } catch (Exception e) {
