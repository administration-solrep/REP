...
public class StatistiqueMinistere implements Serializable {
    ...
    public StatistiqueMinistere(long id, String ministere, String edition, boolean actif, int ordreProtocolaire, int nbRenouvelle, int nbRenouvelleEC, int nbRetire, int nbQuestionSsReponse, int nbQuestionSsReponseSup2Mois) {
        super();
        this.id = id;
    ...
    public String toString() {
        return "StatistiqueMinistere [id=" + id + ", ministere=" + ministere + ", actif=" + actif + ", ordreProtocolaire=" + ordreProtocolaire + ", nbRenouvelle=" + nbRenouvelle + ", nbRetire=" + nbRetire + ", nbQuestionSsReponse=" + nbQuestionSsReponse + ", nbQuestionSsReponseSup2Mois=" + nbQuestionSsReponseSup2Mois + "]";
    }
}
