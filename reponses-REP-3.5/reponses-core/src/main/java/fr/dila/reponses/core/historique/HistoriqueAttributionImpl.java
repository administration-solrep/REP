...
public class HistoriqueAttributionImpl implements HistoriqueAttribution {
    ...
    public String getMinAttribution() {
    	return PropertyUtil.getStringProperty(getDocument(), ReponsesSchemaConstant.HISTORIQUE_ATTRIBUTION_DOCUMENT_SCHEMA, 
    			ReponsesSchemaConstant.HISTORIQUE_ATTRIBUTION_MIN_PROPERTY);
    }

    @Override
    public Calendar getDateAttribution() {
        return PropertyUtil.getCalendarProperty(getDocument(), ReponsesSchemaConstant.HISTORIQUE_ATTRIBUTION_DOCUMENT_SCHEMA, 
	...
	public void setMinAttribution(String minAttribution) {
		PropertyUtil.setProperty(getDocument(), ReponsesSchemaConstant.HISTORIQUE_ATTRIBUTION_DOCUMENT_SCHEMA, 
    			ReponsesSchemaConstant.HISTORIQUE_ATTRIBUTION_MIN_PROPERTY, minAttribution);
	}

	@Override
	public void setDateAttribution(Calendar dateAttribution) {
		PropertyUtil.setProperty(getDocument(), ReponsesSchemaConstant.HISTORIQUE_ATTRIBUTION_DOCUMENT_SCHEMA, 
    			ReponsesSchemaConstant.HISTORIQUE_ATTRIBUTION_DATE_PROPERTY, dateAttribution);
	}

	@Override
	public void setTypeAttribution(String typeAttribution) {
		PropertyUtil.setProperty(getDocument(), ReponsesSchemaConstant.HISTORIQUE_ATTRIBUTION_DOCUMENT_SCHEMA, 
    			ReponsesSchemaConstant.HISTORIQUE_ATTRIBUTION_TYPE_PROPERTY, typeAttribution);
	}
}
