 ...
 * @author jtremeaux
 */
@Operation(id = UpdateDossierStateOperation.ID,
...
public class UpdateDossierStateOperation {
     ...
     */
    public final static String ID = "Reponses.Distribution.UpdateDossierState";

    public final static String DESCRIPTION = "Cette opération met à jour l'état d'un dossier";
     ...
     */
    @OperationMethod
    public void updateDossierState() throws ClientException {
        @SuppressWarnings("unchecked")
        final List<CaseLink> caseLinks = (List<CaseLink>) context.get(CaseConstants.OPERATION_CASE_LINKS_KEY);
        for (final CaseLink link : caseLinks) {
