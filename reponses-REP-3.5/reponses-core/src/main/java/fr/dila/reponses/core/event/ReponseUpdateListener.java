...
public class ReponseUpdateListener implements EventListener {
	...
	public void handleEvent(Event event) throws ClientException {
		...
		if (!(event.getName().equals(
				ReponsesEventConstant.DOSSIER_REPONSE_UPDATE_EVENT) || event
				.getName()
				.equals(ReponsesEventConstant.DOSSIER_REPONSE_VERSION_UPDATE_EVENT))) {
			return;
		}
		...
		if(event.getName().equals(
				ReponsesEventConstant.DOSSIER_REPONSE_UPDATE_EVENT)){
