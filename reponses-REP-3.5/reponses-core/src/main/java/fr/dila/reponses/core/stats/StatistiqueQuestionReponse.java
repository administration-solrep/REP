...
public class StatistiqueQuestionReponse implements Serializable {
    ...
    public StatistiqueQuestionReponse(long id, String ministere, String edition, boolean actif, int ordreProtocolaire, String origine, int nbQuestion, int nbRepondu1Mois, int nbRepondu2Mois, int nbReponduSuperieur) {
        super();
        this.id = id;
    ...
    public String toString() {
        return "StatistiqueQuestionReponse [id=" + id + ", ministere=" + ministere + ", actif=" + actif + ", ordreProtocolaire=" + ordreProtocolaire + ", origine=" + origine + ", nbQuestion=" + nbQuestion + ", nbRepondu1Mois=" + nbRepondu1Mois + ", nbRepondu2Mois=" + nbRepondu2Mois + ", nbReponduSuperieur=" + nbReponduSuperieur + "]";
    }
}
