...
public class DossierLinkImpl extends STDossierLinkImpl implements DossierLink {
    ...
    public Long getNumeroQuestion() {
        return getLongProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA,
                DossierConstants.DOSSIER_REPONSES_LINK_NUMERO_QUESTION_PROPERTY);
    }

    @Override
    public void setNumeroQuestion(Long numeroQuestion) {
        setProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA,
                DossierConstants.DOSSIER_REPONSES_LINK_NUMERO_QUESTION_PROPERTY, numeroQuestion);
    }

    @Override
    public String getTypeQuestion() {
        return getStringProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA,
    ...
    public void setTypeQuestion(String typeQuestion) {
        setProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA,
                DossierConstants.DOSSIER_REPONSES_LINK_TYPE_QUESTION_PROPERTY, typeQuestion);
    }
    ...
    public void setSourceNumeroQuestion(String sourceNumero) {
        setProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA,
                DossierConstants.DOSSIER_REPONSES_LINK_SOURCE_NUMERO_QUESTION_PROPERTY, sourceNumero);
    }
    ...
    public Calendar getDatePublicationJO() {
        return getDateProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA,
	...
	public String getEtatsQuestion() {
		return getStringProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA, DossierConstants.DOSSIER_REPONSES_ETATS_QUESTION_PROPERTY);
	}

	@Override
	public void setEtatsQuestion(String etatsQuestion) {
		setProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA, DossierConstants.DOSSIER_REPONSES_ETATS_QUESTION_PROPERTY, etatsQuestion);		
	}
	...
	public String getMotsCles() {
		return getStringProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA, DossierConstants.DOSSIER_REPONSES_MOTS_CLES_PROPERTY);
	}

	@Override
	public void setMotsCles(String motsCles) {
		setProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA, DossierConstants.DOSSIER_REPONSES_MOTS_CLES_PROPERTY, motsCles);		
	}

	@Override
	public void setEtatQuestionSimple(String etatQuestion) {
        setProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA, DossierConstants.DOSSIER_ETAT_QUESTION_ITEM_PROPERTY, etatQuestion);
    }
    
    @Override
    public String getEtatQuestionSimple() {
        return getStringProperty(DossierConstants.DOSSIER_REPONSES_LINK_SCHEMA, DossierConstants.DOSSIER_ETAT_QUESTION_ITEM_PROPERTY);
    }
    ...
    public Dossier getDossier(CoreSession session) {
        return getCase(session).getDocument().getAdapter(Dossier.class);
    }
    
    @Override
    public List<String> getInitialActionInternalParticipant() {
        return getListStringProperty(CaseConstants.DISTRIBUTION_SCHEMA, DossierConstants.INITIAL_ACTION_INTERNAL_PARTICIPANTS_PROPERTY_NAME);
    }
    
    @Override
    public void setInitialActionInternalParticipant(List<String> initialActionInternamParticipant) {
        setProperty(CaseConstants.DISTRIBUTION_SCHEMA, DossierConstants.INITIAL_ACTION_INTERNAL_PARTICIPANTS_PROPERTY_NAME, initialActionInternamParticipant);
    }
    
    @Override
    public List<String> getAllActionParticipant() {
        return getListStringProperty(CaseConstants.DISTRIBUTION_SCHEMA, DossierConstants.ALL_ACTION_PARTICIPANTS_PROPERTY_NAME);
    }
    
    @Override
    public void setAllActionParticipant(List<String> allActionParticipant) {
        setProperty(CaseConstants.DISTRIBUTION_SCHEMA, DossierConstants.ALL_ACTION_PARTICIPANTS_PROPERTY_NAME, allActionParticipant);
    }   
}
