...
public final class DossierConstants {
	 ...
	 */
	public static final String	QUESTION_NUMERO_XPATH										= QUESTION_DOCUMENT_SCHEMA_PREFIX
																									+ ":"
																									+ DOSSIER_NUMERO_QUESTION;

	public static final String	QUESTION_LEGISLATURE_XPATH									= QUESTION_DOCUMENT_SCHEMA_PREFIX
																									+ ":"
																									+ DOSSIER_LEGISLATURE_QUESTION;

	public static final String	QUESTION_TYPE_QUESTION_XPATH								= QUESTION_DOCUMENT_SCHEMA_PREFIX
																									+ ":"
																									+ DOSSIER_TYPE_QUESTION;

	public static final String	QUESTION_SOURCE_NUMERO_PROP									= "sourceNumeroQuestion";

	public static final String	QUESTION_SOURCE_NUMERO_XPATH								= QUESTION_DOCUMENT_SCHEMA_PREFIX
																									+ ":"
																									+ QUESTION_SOURCE_NUMERO_PROP;
	...
	public static final String	INITIAL_ACTION_INTERNAL_PARTICIPANTS_PROPERTY_NAME			= "initial_action_internal_participant_mailboxes";
