...
@XmlType(propOrder={"id_question", "legislature", "date_publication_jo", "page_jo", "statut", "auteur", "id_ministre_depot", "id_ministre_attributaire", "erratum_question", "erratum_reponse", "rappel", "date_renouvellement_question", "date_signalement_question", "date_abandon_question"})
public class QuestionJAXB {
	...
	public QuestionJAXB(int id_question, int legislature, String date_publication_jo, String page_jo, String statut,
			Auteur auteur, int id_ministre_depot, int id_ministre_attributaire, Rappel rappel, boolean erratum_question, boolean erratum_reponse,
			String date_renouvellement_question, String date_signalement_question, String date_cloture_question, String date_publication_reponse) {
		super();
