...
//	@Column(name = "HASHCONNEXITEAN")
//	private String hashConnexiteAN;
//	
//	@Column(name = "CIRCONSCRIPTIONAUTEUR")
//	private String circonscriptionAuteur;
//	
//	@Column(name = "GROUPEPOLITIQUE")
//	private String groupePolitique;
//	
//	@Column(name = "HASREPONSEINITIEE")
//	private Boolean hasReponseInitiee;
	
	@Column(name = "DATERECEPTIONQUESTION")
	private Date dateReceptionQuestion;
	
//	@Column(name = "HASHCONNEXITESE")
//	private String hashConnexiteSE;
	
//	@Column(name = "TEXTEQUESTION", length=1000000)
...
//	@Column(name = "HASHCONNEXITETITRE")
//	private String hashConnexiteTitre;
...
//	@Column(name = "CARACTERISTIQUEQUESTION")
//	private String caracteristiqueQuestion;
	...
	public Question(String id, String etatQuestion, String intituleMinistere, Boolean etatRenouvelé, Integer legislatureQuestion, String idMandat,
			String hashConnexiteTexte, Date dateCaduciteQuestion, Boolean etatSignale, String nomCompletAuteur, String origineQuestion, Boolean etatRappele,
			String sourceNumeroQuestion, Date datePublicationJO, Boolean etatNonRetire, String etatsQuestion, String pageJO, Boolean etatRetire, Date dateTransmissionAssemblees,
			Date dateRetraitQuestion, String titreJOMinistere, String texteJoint, Date dateRenouvellementQuestion, String senatQuestionTitre, String idMinistereInterroge,
			String hashConnexiteAN, String circonscriptionAuteur, String groupePolitique, Boolean hasReponseInitiee, Date dateReceptionQuestion, 
			String hashConnexiteSE, String texteQuestion, String motsCles, String civiliteAuteur, String nomAuteur, String hashConnexiteTitre, 
			Boolean etatReattribue, String prenomAuteur, String typeQuestion, String caracteristiqueQuestion, Integer numeroQuestion, String idMinistereReattributaire,
			String intituleMinistereReattributaire, Date dateSignalementQuestion, Date dateClotureQuestion, Date dateRappelQuestion, String idMinistereRattachement, 
			String intituleMinistereRattachement, String idDirectionPilote, String intituleDirectionPilote) {
		super();
		this.id = id;
...
//	}
	...
	public void setIntituleMinistereAttributaire(
			String intituleMinistereAttributaire) {
	...
	public void setIntituleMinistereRattachement(
