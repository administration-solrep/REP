...
public class Reponse implements Serializable {
	 ...
	 * @param erratum
	 */
	public Reponse(String id, Integer pageJoReponse, Integer identifiant, Integer numeroJoReponse, String anRubrique,
			Boolean isSignatureValide, String signature, String idAuteurReponse, String idAuteurRemoveSignature,
			String verrou, Date datePublicationJoReponse, Date dateValidation, String erratum) {
		super();
		this.id = id;
