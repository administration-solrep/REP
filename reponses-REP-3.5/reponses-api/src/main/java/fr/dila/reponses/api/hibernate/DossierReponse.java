...
public class DossierReponse implements Serializable {
	 ...
	 * @param isArbitrated
	 */
	public DossierReponse(String id, Integer numeroQuestion, String idDocumentQuestion, String lastDocumentRoute,
			String listeElimination, String idDocumentReponse, Boolean etapeRedactionAtteinte, String idDossierLot,
			String idDocumentFdd, String ministereAttributaireCourant, Integer reaffectationCount,
			Boolean etapeSignatureAtteinte, String ministereAttributairePrecedent, String ministereReattribution,
			String labelEtapeSuivante, Boolean historiqueDossierTraite, Boolean isArbitrated, Boolean hasPJ) {
		super();
		this.id = id;
