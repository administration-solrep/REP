...
public final class StringUtil extends StringUtils {
	...
	/**
	 * remplace dans une chaine de caractères les caractères non acceptables
	 * dans un nom de fichier par des tirets, les espaces par des underscores et
	 * les accents par des caractères non accentués
	 *
	 * @see #removeSpacesAndAccent(String)
	 * @param source
	 * @return
	 */
	public static String getValidFilename(String source) {
		return removeSpacesAndAccent(source).replaceAll("[\\\\/:*?\"<>|]", "-");
	}
