...
public final class DateUtil {
	...
	/**
	 * Convertit une date au format dd/MM/yyyy. Si la date est null, on renvoie une chaine vide.
	 * 
	 * @param date
	 *            Date
	 * @return Date formatée
	 */
	public static String formatDDMMYYYYSlashOrNullProof(final Date date) {
		if (date == null) {
			return "";
		}
		SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy", Locale.FRENCH);
