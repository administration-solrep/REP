...
public class ReponsesConstant {
     ...
     */
    public static final String REPONSES_FEUILLE_ROUTE_INTITULE_DIRECTION_PILOTE_PROPERTY_NAME =
    ...
    public static final String REPONSES_MAILBOX_SCHEMA_PREFIX = "rmlbx";

    public static final String REPONSES_MAILBOX_PRECALCUL_LIST_PROP = "preCalculList";

    public static final String REPONSES_MAILBOX_PRECALCUL_LIST_XPATH = xPath(
        REPONSES_MAILBOX_SCHEMA_PREFIX,
        REPONSES_MAILBOX_PRECALCUL_LIST_PROP
    );
