...
public interface Dossier extends Serializable, STDossier, DossierCommon {
     ...
     */
    Dossier setDossierProperties(CoreSession session);

    /**
     * Create a FondDeDossier.
     */
    FondDeDossier createFondDeDossier(CoreSession session);
    ...
    Boolean isArchivable(CoreSession session);

    boolean canEliminate(CoreSession session);
     ...
     *
     */
    Boolean isActive(CoreSession session);
     ...
     *
     */
    void addHistoriqueAttribution(
        CoreSession session,
        String feuilleRouteTypeCreationInstanciation,
        String idMinistere
    );
