...
public final class ReponsesEventConstant {
    ...
    public static final String COMMENT_MODIF_FOND_DOSSIER =
        "Modification du fichier {0} par {1} dans le fond de dossier";
    ...
    public static final String QUESTION_REMINDER_EVENT = "questionReminderEvent";
    public static final String QUESTION_REMINDER_EVENT_STEP = "questionReminderEventStep";
    ...
    public static final String COMPUTE_MAILBOX_PRECOMPTAGE_EVENT = "computeMailboxPreComptageEvent";
     ...
     */
    public static final String WEBSERVICE_CHERCHER_ERRATA_REPONSES_COMMENT =
        "label.journal.comment.chercherErrataReponses";
     ...
     * Commentaire de l'événement web service "envoyerReponses"
     */
    public static final String WEBSERVICE_ENVOYER_ERRATA_REPONSES_COMMENT =
        "label.journal.comment.envoyerErrataReponses";
     ...
     */
    public static final String WEBSERVICE_CHERCHER_ERRATA_QUESTION_COMMENT =
        "label.journal.comment.chercherErrataQuestion";
     ...
     */
    public static final String WEBSERVICE_CHERCHER_CHANGEMENT_ETAT_QUESTION_COMMENT =
        "label.journal.comment.chercherChangementEtatQuestion";
     ...
     */
    public static final String WEBSERVICE_ENVOYER_QUESTIONS_ERRATA_COMMENT =
        "label.journal.comment.envoyerQuestionsErrata";
     ...
     */
    public static final String WEBSERVICE_CHERCHER_RETOUR_PUBLICATION_COMMENT =
        "label.journal.comment.chercherRetourPublication";
     ...
     */
    public static final String WEBSERVICE_CHERCHER_MEMBRES_GOUVERNEMENT_COMMENT =
        "label.journal.comment.chercherMembresGouvernement";
     ...
     */
    public static final String WEBSERVICE_CHERCHER_ATTRIBUTION_DATE_COMMENT =
        "label.journal.comment.chercherAttributionsDate";

    /**
     * Evenément de migration de gouvernement (timbres)
     */
    public static final String MIGRATION_GVT_EVENT = "migrationGvtEvent";

    /**
     * Evénement de migration d'entités (migration "EPG")
     */
    public static final String MIGRATION_ENTITE_EVENT = "migrationEntiteEvent";

    /**
     * événement : modification des données JO du bordereau
     */
    public static final String BORDEREAU_JO_UPDATE_EVENT = "bordereauJoUpdate";

    /**
     * commentaire : modification des données JO du bordereau
     */
    public static final String BORDEREAU_JO_UPDATE_COMMENT = "label.journal.comment.updateBordereauJo";
}
