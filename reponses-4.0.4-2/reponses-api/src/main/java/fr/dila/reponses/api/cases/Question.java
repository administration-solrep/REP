...
public interface Question extends DossierCommon, STDomainObject {
     ...
     */
    DocumentModel getQuestionMetadata(Question question);
    ...
    Calendar getDateClotureQuestion();
    ...
    Optional<Calendar> getDateReponseSignalement();

    String getCiviliteEtNomCompletAuteur();
}
