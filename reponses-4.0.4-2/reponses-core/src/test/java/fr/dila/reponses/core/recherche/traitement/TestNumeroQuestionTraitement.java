...
public class TestNumeroQuestionTraitement extends TestCase {
    ...
    public void testNumeros() {
        ...
        assertEquals(
            traitement.parse(chaineNumero),
            "(q.ecm:fulltext_idQuestion LIKE '50') OR (q.qu:numeroQuestion = 1546)"
        );
    }
    ...
    public void testParsingNumero() {
        ...
        assertEquals(
            traitement.parse(chaineNumero),
            "(q.qu:numeroQuestion BETWEEN 1546 AND 1559) OR (q.qu:numeroQuestion = 508) OR (q.qu:numeroQuestion = 559) OR (q.qu:numeroQuestion BETWEEN 805 AND 906)"
        );
    }
}
