...
public class ReponseImpl implements Reponse {
    ...
    public String getTexteReponse() {
        ...
        return PropertyUtil.getStringProperty(
            ...
            DossierConstants.DOSSIER_TEXTE_REPONSE
        );
    }
    ...
    public void setTexteReponse(String texteReponse) {
        ...
        texteReponse = StringHelper.deleteCharNotUTF8(texteReponse);
        texteReponse = StringHelper.deleteHtmlComment(texteReponse);
        // Mise à jour du texte de la reponse sur le schema note
    ...
    public Long getNumeroJOreponse() {
        return PropertyUtil.getLongProperty(
            document,
            DossierConstants.REPONSE_DOCUMENT_SCHEMA,
            DossierConstants.DOSSIER_NUMERO_JO_REPONSE
        );
    }
    ...
    public Calendar getDateJOreponse() {
        return PropertyUtil.getCalendarProperty(
            document,
            DossierConstants.REPONSE_DOCUMENT_SCHEMA,
            DossierConstants.DOSSIER_DATE_JO_REPONSE
        );
    }
    ...
    public Long getPageJOreponse() {
        return PropertyUtil.getLongProperty(
            document,
            DossierConstants.REPONSE_DOCUMENT_SCHEMA,
            DossierConstants.DOSSIER_PAGE_JO_REPONSE
        );
    }
    ...
    public void setErrata(List<RErratum> errata) {
        ...
        PropertyUtil.setProperty(
            document,
            DossierConstants.REPONSE_DOCUMENT_SCHEMA,
            DossierConstants.DOSSIER_ERRATA_PROPERTY,
            listeErratum
        );
    }

    protected List<RErratum> getErrataProperty(String schema, String value) {
        List<RErratum> erratumList = new ArrayList<>();
    ...
    public void setIsSignatureValide(Boolean isSignatureValide) {
        PropertyUtil.setProperty(
            document,
            DossierConstants.REPONSE_DOCUMENT_SCHEMA,
            DossierConstants.DOSSIER_SIGNATURE_VALIDE_REPONSE,
            isSignatureValide
        );
    }
    ...
    public String getAuthorRemoveSignature() {
        return PropertyUtil.getStringProperty(
            document,
            DossierConstants.REPONSE_DOCUMENT_SCHEMA,
            DossierConstants.REPONSE_REMOVE_SIGNATURE_AUTHOR
        );
    }
    ...
    public void setCurrentErratum(String currentErratum) {
        PropertyUtil.setProperty(
            document,
            DossierConstants.REPONSE_DOCUMENT_SCHEMA,
            DossierConstants.REPONSE_CURRENT_ERRATUM,
            currentErratum
        );
    }
