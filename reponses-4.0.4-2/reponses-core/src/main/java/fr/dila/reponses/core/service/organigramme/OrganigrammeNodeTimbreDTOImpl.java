...
public class OrganigrammeNodeTimbreDTOImpl implements OrganigrammeNodeTimbreDTO {
    ...
    public OrganigrammeNodeTimbreDTOImpl(
    ...
    public String getBreakingSealLabel() {
        return BooleanUtils.isTrue(breakingSeal)
            ? "reponses.migration.recap.value.yes"
            : "reponses.migration.recap.value.no";
    }
    ...
    public String getMigratingDossiersClosLabel() {
        return BooleanUtils.isTrue(migratingDossiersClos)
            ? "reponses.migration.recap.value.yes"
            : "reponses.migration.recap.value.no";
    }
