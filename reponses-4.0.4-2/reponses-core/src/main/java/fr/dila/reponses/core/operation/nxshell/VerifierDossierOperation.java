...
public class VerifierDossierOperation {
    ...
    public void run() {
        ...
        try {
            String query =
                "select qu.sourcenumeroquestion, dos.ministereattributairecourant, qu.idministereattributaire, dos.id " +
            ...
            res =
                QueryUtils.doSqlQuery(
                    session,
                    new String[] {
                        "qu:sourceNumeroQuestion",
                        "dos:ministereAttributaireCourant",
                        "qu:idMinistereAttributaire",
                        "dc:title"
                    },
                    query,
                    new Object[] {}
            ...
            if (iterator.hasNext()) {
                while (iterator.hasNext()) {
                    ...
                    log.info(
                        numeroQuestion +
                        " : Le ministère attributaire sur le dossier et la question " +
                        "sont différents (Dossier - id: " +
                        idDossier +
                        ": " +
                        minDossier +
                        ", Question: " +
