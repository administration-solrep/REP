...
public class FavorisIndexationImpl implements FavorisIndexation {
    ...
    public String getTypeIndexation() {
        return PropertyUtil.getStringProperty(
            document,
            ReponsesSchemaConstant.INDEXATION_SCHEMA,
            ReponsesSchemaConstant.INDEXATION_TYPE
        );
    }
    ...
    public String getNiveau1() {
        return PropertyUtil.getStringProperty(
            document,
            ReponsesSchemaConstant.INDEXATION_SCHEMA,
            ReponsesSchemaConstant.INDEXATION_NIVEAU1
        );
    }
    ...
    public String getNiveau2() {
        return PropertyUtil.getStringProperty(
            document,
            ReponsesSchemaConstant.INDEXATION_SCHEMA,
            ReponsesSchemaConstant.INDEXATION_NIVEAU2
        );
    }
