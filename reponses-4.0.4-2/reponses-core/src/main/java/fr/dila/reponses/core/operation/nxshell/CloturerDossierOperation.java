 ...
 */
@Operation(
    id = CloturerDossierOperation.ID,
    category = CaseConstants.CASE_MANAGEMENT_OPERATION_CATEGORY,
    label = "CloturerDossier",
    description = "Cloture un dossier en cours"
)
    ...
    public void run() {
        ...
        if (mode.toUpperCase().equals(MODE_LECTURE)) {
            ...
            final List<DocumentModel> questionsDoc = QueryUtils.doUFNXQLQueryAndFetchForDocuments(
                ...
                "Question",
                query + ORDER_BY_ID,
                new Object[] { origine.toUpperCase(), numero }
            );
            ...
            LOGGER.info(
                "Début de cloture de la question ayant comme numéro " +
                origine +
                " " +
                numero +
            ...
            if (sizeTotale == 0) {
                ...
                LOGGER.warn(
                    "Plusieurs dossiers ayant comme numéro " +
                    origine +
                    " " +
                    numero +
            ...
            try {
                ...
                whereQueryDossiersIncorrects =
                    whereQueryDossiersIncorrects + QUERY_WHERE_NUMERO_QUESTION + question.getNumeroQuestion() + "'";
            } catch (Exception e) {
                LOGGER.error(
