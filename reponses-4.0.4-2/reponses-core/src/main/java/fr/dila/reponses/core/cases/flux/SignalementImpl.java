...
public class SignalementImpl implements Signalement {
    ...
    public void setDateEffet(Date dateEffet) {
        ...
        this.signalementMap.put(DossierConstants.DOSSIER_SIGNALEMENT_DATEDEFFET, dateEffet);
    }
    ...
    public void setDateAttendue(Date dateAttendue) {
        ...
        this.signalementMap.put(DossierConstants.DOSSIER_SIGNALEMENT_DATEATTENDUE, dateAttendue);
    }
    ...
    public void setSignalementMap(Map<String, Serializable> signalementMap) {
        ...
        GregorianCalendar gc1 =
            ((GregorianCalendar) signalementMap.get(DossierConstants.DOSSIER_SIGNALEMENT_DATEDEFFET));

        this.dateEffet = (gc1 != null) ? gc1.getTime() : null;

        GregorianCalendar gc2 =
            ((GregorianCalendar) signalementMap.get(DossierConstants.DOSSIER_SIGNALEMENT_DATEATTENDUE));
