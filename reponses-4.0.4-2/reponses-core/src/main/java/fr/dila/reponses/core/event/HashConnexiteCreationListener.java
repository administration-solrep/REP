...
public class HashConnexiteCreationListener implements PostCommitEventListener {
    ...
    protected void handleEvent(Event event) {
        ...
        if (event.getName().equals(DocumentEventTypes.DOCUMENT_CREATED)) {
            question.setIdMinistereAttributaire((String) model.getPropertyValue("qu:idMinistereInterroge"));
            question.setIntituleMinistereAttributaire((String) model.getPropertyValue("qu:intituleMinistere"));
            question.setIdMinistereRattachement((String) model.getPropertyValue("qu:idMinistereInterroge"));
            question.setIntituleMinistereRattachement((String) model.getPropertyValue("qu:intituleMinistere"));
        ...
        try {
            ...
            log.error(
                "Le hash sur le titre n'est pas calculable pour la question N°" + question.getNumeroQuestion(),
                e
            );
        }
        ...
        try {
            ...
            log.error(
                "Le hash sur le texte n'est pas calculable pour la question N°" + question.getNumeroQuestion(),
                e
            );
        }
        ...
        try {
            ...
            log.error(
                "Le hash sur l'indexation AN n'est pas calculable pour la question N°" + question.getNumeroQuestion(),
                e
            );
        }
        ...
        try {
            ...
            log.error(
                "Le hash sur l'indexation Senat n'est pas calculable pour la question N°" +
        ...
        if (modif) {
            try {
                ...
                log.error(
                    "La question N°" + question.getNumeroQuestion() + "n'as pu être sauvegardée après le hashage",
                    e
                );
            }
        }
