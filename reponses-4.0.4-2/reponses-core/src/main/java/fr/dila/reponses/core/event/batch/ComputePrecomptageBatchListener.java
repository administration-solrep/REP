...
public class ComputePrecomptageBatchListener extends AbstractBatchEventListener implements StoppableBatch {
    /**
    ...
    public STLogEnum getStoppageCode() {
        return ReponsesLogEnumImpl.CANCEL_B_PRECOMPTAGE_TEC;
    }
