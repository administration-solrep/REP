...
public class RequeteChampThemeSENATParameterServiceImpl implements ChampParameter {

    @Override
    public Map<String, Serializable> getAdditionalParameters() {
        return ImmutableMap.of(
            SSRechercheChampConstants.OPTIONS_PARAMETER_NAME,
            new ArrayList<>(ReponsesUIServiceLocator.getSelectValueUIService().getThemesSenat())
        );
    }
}
