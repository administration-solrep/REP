...
class DirectionUtils {    
	...
	public static PosteNode getStepPoste(final SSRouteStep step) throws ClientException, PosteNotFoundException {
    ...
    for (Long offset = (long) 0; offset <= count; offset += limit) {
        ...
        for (DocumentModel feuilleRouteDoc : feuilleRouteModelList) {
            ...
            for (int i = listRouteTableElement.size() - 1; i >= 0; i--) {
                SSRouteStep routeStep = listRouteTableElement.get(i).getRouteStep();
