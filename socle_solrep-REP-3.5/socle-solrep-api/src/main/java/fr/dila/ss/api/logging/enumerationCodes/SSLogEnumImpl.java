...
public enum SSLogEnumImpl implements STLogEnum {
     ...
     */
    DEL_FILE_FDD_TEC(STTypesEnum.DELETE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.FDD_FILE, "Suppression fichier de fond de dossier"),
    /**
     ...
     */
    DEL_PARAPHEUR_FILE_TEC(STTypesEnum.DELETE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.PARAPHEUR_FILE, "Suppression fichier de parapheur"),
     ...
     */
    CREATE_FILE_FDD_TEC(STTypesEnum.CREATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.FDD_FILE, "Création de fichier de fond de dossier"),
    /**
     ...
     */
    GET_STEP_TEC(STTypesEnum.GET, STPorteesEnum.TECHNIQUE, SSObjetsEnum.STEP, "Récupération d'étape de feuille de route"),
 
    //**************************************** ECHEC D'ACTIONS **************************************************
    /**
     * FAIL_GET_STEP : {@link STTypesEnum#FAIL_GET}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#STEP}
     */
    FAIL_GET_STEP_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, SSObjetsEnum.STEP, "Echec récupération étape de feuille de route"),
    /**
     * FAIL_UPDATE_STEP : {@link STTypesEnum#FAIL_UPDATE}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#STEP}
     */
    FAIL_UPDATE_STEP_TEC(STTypesEnum.FAIL_UPDATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.STEP, "Echec modification étape"),
    /**
     * FAIL_GET_FDR : {@link STTypesEnum#FAIL_GET}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#FDR}
     */
    FAIL_GET_FDR_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, SSObjetsEnum.FDR, "Echec récupération de feuille de route"),
    /**
     ...
     */
    FAIL_GET_FDR_FONC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, SSObjetsEnum.FDR, "Echec récupération de feuille de route (fonc)"),
    /**
     * FAIL_UPDATE_FDR : {@link STTypesEnum#FAIL_UPDATE}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#FDR}
     */
    FAIL_UPDATE_FDR_TEC(STTypesEnum.FAIL_UPDATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.FDR, "Echec modification de feuille de route"),
    /**
     * FAIL_UPDATE_FDR : {@link STTypesEnum#FAIL_UPDATE}_{@link STPorteesEnum#FONCTIONNELLE}_{@link SSObjetsEnum#FDR}
     */
    FAIL_UPDATE_FDR_FONC(STTypesEnum.FAIL_UPDATE, STPorteesEnum.FONCTIONNELLE, SSObjetsEnum.FDR, "Echec modification de feuille de route (fonc)"),
    /**
     ...
     */
    FAIL_CREATE_GROUPE_POLITIQUE_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.GROUPE_POLITIQUE, "Echec création de groupe politique"),
    /**
     * Echec de génération du rapport birt : {@link STTypesEnum#FAIL_CREATE}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#BIRT}
     */
    FAIL_CREATE_BIRT_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BIRT, "Echec de génération du rapport birt"),
    /**
     ...
     */
    FAIL_UPDATE_FDD_TEC(STTypesEnum.FAIL_UPDATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.FDD_FILE, "Echec de mise à jour du fichier de fond de dossier"),
    /**
     ...
     */
    FAIL_DEL_FILE_FDD_TEC(STTypesEnum.FAIL_DEL, STPorteesEnum.TECHNIQUE, SSObjetsEnum.FDD_FILE, "Echec de suppression du fichier de fond de dossier"),
    /**
     ...
     */
    FAIL_DEL_BIRT_TEC(STTypesEnum.FAIL_DEL, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BIRT, "Echec lors de la suppression du rapport birt"),
    /**
     * Echec de sauvegarde du rapport birt : {@link STTypesEnum#FAIL_SAVE}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#BIRT}
     */
    FAIL_SAVE_BIRT_TEC(STTypesEnum.FAIL_SAVE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BIRT, "Echec de la sauvegarde du rapport birt"),
    /**
     ...
     */
    FAIL_UPDATE_PARAPHEUR_FILE_TEC(STTypesEnum.FAIL_UPDATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.PARAPHEUR_FILE, "Echec de mise à jour du fichier de parapheur"),
    /**
     * Echec de suppression du fichier de fond de dossier : {@link STTypesEnum#FAIL_DEL}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#FDD_FILE}
     */
    FAIL_DEL_PARAPHEUR_FILE_TEC(STTypesEnum.FAIL_DEL, STPorteesEnum.TECHNIQUE, SSObjetsEnum.PARAPHEUR_FILE, "Echec de suppression du fichier de parapheur"),
    /**
     ...
     */
    FAIL_CREATE_FDD_FOLDER_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.FDD_FOLDER, "Echec de création d'un répertoire de fond de dossier"),
    /**
     ...
     */
    FAIL_EXPORT_STATS_FONC(STTypesEnum.FAIL_EXPORT, STPorteesEnum.FONCTIONNELLE, SSObjetsEnum.STATS, "Erreur d'export des statistiques"),
    /**
     ...
     */
    FAIL_EXPORT_STATS_TEC(STTypesEnum.FAIL_EXPORT, STPorteesEnum.TECHNIQUE, SSObjetsEnum.STATS, "Erreur d'export des statistiques"),
    /**
     * Echec de réupération du fond de dossier : {@link STTypesEnum#FAIL_GET}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#FDD}
     */
    FAIL_GET_FDD_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, SSObjetsEnum.FDD, "Echec de réupération du fond de dossier"),
    /**
     * Echec d'ajout d'une note : {@link STTypesEnum#FAIL_ADD}_{@link STPorteesEnum#FONCTIONNELLE}_{@link SSObjetsEnum#NOTE}
     */
    FAIL_ADD_NOTE_FONC(STTypesEnum.FAIL_ADD, STPorteesEnum.FONCTIONNELLE, SSObjetsEnum.NOTE, "Echec d'ajout d'une note"),
    /**
     * Echec d'ajout d'une note : {@link STTypesEnum#FAIL_ADD}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#NOTE}
     */
    FAIL_ADD_NOTE_TEC(STTypesEnum.FAIL_ADD, STPorteesEnum.TECHNIQUE, SSObjetsEnum.NOTE, "Echec d'ajout d'une note (tec)"),
    /**
     ...
     */
    FAIL_REATTR_DOSSIER_FONC(SSTypesEnum.FAIL_REATTR, STPorteesEnum.FONCTIONNELLE, STObjetsEnum.DOSSIER, "Echec de réattribution d'un dossier"),
    /**
     ...
     */
    FAIL_REATTR_DOSSIER_TEC(SSTypesEnum.FAIL_REATTR, STPorteesEnum.TECHNIQUE, STObjetsEnum.DOSSIER, "Echec de réattribution d'un dossier (tec)"),
    /**
     * Echec de validation d'étape : {@link STTypesEnum#FAIL_VALIDATE}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#STEP}
     */
    FAIL_VALIDATE_STEP_TEC(STTypesEnum.FAIL_VALIDATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.STEP, "Echec de validation d'étape"),
    /**
     ...
     */
    FAIL_PUBLISH_BIRT_TEC(STTypesEnum.FAIL_PUBLISH, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BIRT, "Echec de publication du rapport birt"),
    
    //**************************************** ACTIONS TECHNIQUES *****************************************
    /**
     * Mise à jour d'étapes de feuille de route : {@link STTypesEnum#UPDATE}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#STEP}
     */
    UPDATE_STEP_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.STEP, "Mise à jour d'étapes de feuille de route"),
    /**
     ...
     */
    PROCESS_B_DOSS_BLOQUES_TEC(STTypesEnum.PROCESS, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_DOSS_BLOQUES, "Exécution du batch de dossiers bloqués"),
    /**
     ...
     */
    PROCESS_B_DL_INCOHERENT_TEC(STTypesEnum.PROCESS, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_DL_INCOHERENT, "Exécution du batch de détection d'incohérence des dossiers links"), 
    /**
     ...
     */
    PROCESS_B_VALID_STEP_TEC(STTypesEnum.PROCESS, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_VALID_AUTO_STEP, "Execution batch validation automatique d'étapes"),
    /**
     ...
     */
    INIT_B_UNLOCK_ORGA_TEC(STTypesEnum.INIT, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_UNLOCK_ORGA, "Début du batch de déverrouillage de l'organigramme"),
    /**
     ...
     */
    END_B_UNLOCK_ORGA_TEC(STTypesEnum.END, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_UNLOCK_ORGA, "Fin du batch de déverrouillage de l'organigramme"),
    /**
     ...
     */
    INIT_B_DEL_USERS_TEC(STTypesEnum.INIT, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_USERS_DELETION, "Début du batch de suppression des utilisateurs"),
    /**
     ...
     */
    END_B_DEL_USERS_TEC(STTypesEnum.END, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_USERS_DELETION, "Fin du batch de suppression des utilisateurs"),
    /**
     ...
     */
    FAIL_PROCESS_B_DEL_USERS_TEC(STTypesEnum.FAIL_PROCESS, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_USERS_DELETION, "Echec dans l'exécution du batch de suppression des utilisateurs"),
    /**
     ...
     */
    PROCESS_B_DEL_USERS_TEC(STTypesEnum.PROCESS, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_USERS_DELETION, "Exécution du batch de suppression des utilisateurs"),
    
    //*******************************************************IUC************************************************************
    /**
     * GET_IUC_TEC : {@link STTypesEnum#GET}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#INFO_UTILISATEUR_CO}
     */
    GET_IUC_TEC(STTypesEnum.GET, STPorteesEnum.TECHNIQUE, SSObjetsEnum.INFO_UTILISATEUR_CO, "Récupération info utilisateur connexion"),
    /**
     * UPDATE_IUC_TEC : {@link STTypesEnum#UPDATE}_{@link STPorteesEnum#TECHNIQUE}_{@link SSObjetsEnum#INFO_UTILISATEUR_CO}
     */
    UPDATE_IUC_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.INFO_UTILISATEUR_CO, "Mise à jour info utilisateur connexion"),
    /**
     ...
     */
    DEL_INFO_USER_CO_TEC(STTypesEnum.DELETE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.INFO_UTILISATEUR_CO, "Suppression infoUtilisateurConnexion"),
    /**
     ...
     */
    INIT_B_CLOSE_USERS_CONNEC_TEC(STTypesEnum.INIT, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_CLOSE_USERS_CONNEC, "Début du batch de déconnexion des utilisateurs"),
    /**
     ...
     */
    FAIL_PROCESS_B_CLOSE_USERS_CONNEC_TEC(STTypesEnum.FAIL_PROCESS, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_CLOSE_USERS_CONNEC, "Echec dans l'exécution du batch de déconnexion des utilisateurs"),
    /**
     ...
     */
    END_B_CLOSE_USERS_CONNEC_TEC(STTypesEnum.END, STPorteesEnum.TECHNIQUE, SSObjetsEnum.BATCH_CLOSE_USERS_CONNEC, "Fin du batch de déconnexion des utilisateurs"),
     ...
     */
    MIGRATE_MOD_FDR_TEC(STTypesEnum.MIGRATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.MODELE_FDR, "Migration modèles de feuilles de route"), 
    /**
     ...
     */
    FAIL_MIGRATE_FDR_TEC(STTypesEnum.FAIL_MIGRATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.FDR, "Echec de migration des feuilles de route"), 
    /**
     ...
     */
    FAIL_MIGRATE_MOD_FDR_TEC(STTypesEnum.FAIL_MIGRATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.MODELE_FDR, "Echec de migration des modèles de feuille de route"),
    /**
     ...
     */
    FAIL_BRISURE_SIGNATURE_TEC(STTypesEnum.FAIL_MIGRATE, STPorteesEnum.TECHNIQUE, SSObjetsEnum.SIGNATURE, "Echec de brisure du cachet des dossiers");
    ...
    public String getCode() {
        ...
        code.append(type.getCodeNumberStr())
