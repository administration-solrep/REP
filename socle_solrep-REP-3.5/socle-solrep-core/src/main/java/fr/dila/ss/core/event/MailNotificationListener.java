...
/**
 * Gestionnaire d'évènements qui permet l'envoi d'un mail aux membres du poste lors de la distribution du dossier.
 * 
 * @author feo
 * @author sly
 */
public class MailNotificationListener extends AbstractFilterEventListener<EventContext> {
	...
	@Override
	protected final void doHandleEvent(final Event event, final EventContext ctx) throws ClientException {
		try {
