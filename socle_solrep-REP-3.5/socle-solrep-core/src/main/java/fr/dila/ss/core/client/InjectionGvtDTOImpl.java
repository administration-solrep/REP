...
public class InjectionGvtDTOImpl implements InjectionGvtDTO, Serializable{
	 ...
	 * @param isGvt
	 */
	public InjectionGvtDTOImpl(final String ordreProtocolaireReponses, final boolean aCreerReponses,
			final String libelleCourt, final String libelleLong, final String formule, final String civilite,
			final String prenom, final String nom, final String prenomNom, final Date dateDeDebut, final Date dateDeFin,
			final boolean isGvt, final boolean aModifierReponses, String idOrganigramme) {
		this.id = null;
		this.ordreProtocolaireReponses = ordreProtocolaireReponses;
		this.aCreerReponses = aCreerReponses;
		this.libelleCourt = libelleCourt;
